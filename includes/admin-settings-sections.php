        ...
        <div class="ttp-collapsible-content">
            ...
            <table class="form-table">
                ...
                <tr><th><label for="talktopc_override_voice">Voice</label></th>
                    <td><select id="talktopc_override_voice" name="talktopc_override_voice" class="regular-text"><option value="">-- Use agent default --</option></select><span id="ttp-voice-loading" class="spinner"></span></td></tr>
                ...
                <tr><th><label for="talktopc_override_language">Language</label></th>
                    <td><select id="talktopc_override_language" name="talktopc_override_language" class="regular-text"><option value="">-- All languages --</option></select><span id="ttp-language-loading" class="spinner"></span></td></tr>
        ...
        <div class="ttp-collapsible-content">
            <table class="form-table">
                ...
                <tr><th><label for="talktopc_button_bg_color">Background Color</label></th>
                    <td><input type="text" id="talktopc_button_bg_color" name="talktopc_button_bg_color" value="<?php echo esc_attr(get_option('talktopc_button_bg_color')); ?>" class="ttp-color-picker" data-default-color="#FFFFFF"></td></tr>
                <tr><th><label for="talktopc_button_hover_color">Hover Color</label></th>
                    <td><input type="text" id="talktopc_button_hover_color" name="talktopc_button_hover_color" value="<?php echo esc_attr(get_option('talktopc_button_hover_color')); ?>" class="ttp-color-picker" data-default-color="#F5F5F5"></td></tr>
                <tr><th>Shadow</th>
    ...
    <div class="ttp-card ttp-collapsible">
        ...
        <div class="ttp-collapsible-content">
            <table class="form-table">
                ...
                <tr class="ttp-icon-custom-row"><th><label for="talktopc_icon_custom_image">Image URL</label></th>
                ...
                <tr class="ttp-icon-emoji-row" style="display:none;"><th><label for="talktopc_icon_emoji">Emoji</label></th>
                ...
                <tr class="ttp-icon-text-row" style="display:none;"><th><label for="talktopc_icon_text">Text</label></th>
                ...
                <tr><th><label for="talktopc_icon_bg_color">Icon Background</label></th>
                    <td><input type="text" id="talktopc_icon_bg_color" name="talktopc_icon_bg_color" value="<?php echo esc_attr(get_option('talktopc_icon_bg_color')); ?>" class="ttp-color-picker" data-default-color="#FFFFFF"></td></tr>
            </table>
        </div>
    </div>
    <?php
        ...
        <div class="ttp-collapsible-content">
            <table class="form-table">
                ...
                <tr><th><label for="talktopc_panel_bg_color">Background Color</label></th>
                    <td><input type="text" id="talktopc_panel_bg_color" name="talktopc_panel_bg_color" value="<?php echo esc_attr(get_option('talktopc_panel_bg_color')); ?>" class="ttp-color-picker" data-default-color="#FFFFFF"></td></tr>
        ...
        <div class="ttp-collapsible-content">
            <table class="form-table">
                ...
                <tr><th><label for="talktopc_header_bg_color">Background Color</label></th>
                    <td><input type="text" id="talktopc_header_bg_color" name="talktopc_header_bg_color" value="<?php echo esc_attr(get_option('talktopc_header_bg_color')); ?>" class="ttp-color-picker" data-default-color="#7C3AED"></td></tr>
                <tr><th><label for="talktopc_header_text_color">Text Color</label></th>
                    <td><input type="text" id="talktopc_header_text_color" name="talktopc_header_text_color" value="<?php echo esc_attr(get_option('talktopc_header_text_color')); ?>" class="ttp-color-picker" data-default-color="#FFFFFF"></td></tr>
...
function talktopc_render_footer_settings() {
    ...
    <div class="ttp-card ttp-collapsible">
        ...
        <div class="ttp-collapsible-content">
            ...
            <div class="ttp-footer-preview" style="margin: 15px 0; padding: 8px 16px; background: <?php echo esc_attr(get_option('talktopc_footer_bg_color', '#f9fafb')); ?>; border: 1px solid #e5e7eb; border-radius: 4px; text-align: center;">
            ...
            <table class="form-table">
                <tr><th><label for="talktopc_footer_bg_color">Background Color</label></th>
                    <td><input type="text" id="talktopc_footer_bg_color" name="talktopc_footer_bg_color" value="<?php echo esc_attr(get_option('talktopc_footer_bg_color')); ?>" class="ttp-color-picker" data-default-color="#f9fafb"></td></tr>
                <tr><th><label for="talktopc_footer_text_color">Text Color</label></th>
                    <td><input type="text" id="talktopc_footer_text_color" name="talktopc_footer_text_color" value="<?php echo esc_attr(get_option('talktopc_footer_text_color')); ?>" class="ttp-color-picker" data-default-color="#9ca3af"></td></tr>
                <tr><th><label for="talktopc_footer_hover_color">Hover Color</label></th>
                    <td><input type="text" id="talktopc_footer_hover_color" name="talktopc_footer_hover_color" value="<?php echo esc_attr(get_option('talktopc_footer_hover_color')); ?>" class="ttp-color-picker" data-default-color="#7C3AED"></td></tr>
            </table>
        </div>
    </div>
    <?php
        ...
        <div class="ttp-collapsible-content">
            ...
            <table class="form-table">
                ...
                <tr><th><label for="talktopc_landing_title_color">Title Color</label></th>
                    <td><input type="text" id="talktopc_landing_title_color" name="talktopc_landing_title_color" value="<?php echo esc_attr(get_option('talktopc_landing_title_color')); ?>" class="ttp-color-picker" data-default-color="#1e293b"></td></tr>
            </table>
            ...
            <table class="form-table">
                <tr><th><label for="talktopc_landing_card_bg_color">Card Background</label></th>
                    <td><input type="text" id="talktopc_landing_card_bg_color" name="talktopc_landing_card_bg_color" value="<?php echo esc_attr(get_option('talktopc_landing_card_bg_color')); ?>" class="ttp-color-picker" data-default-color="#FFFFFF"></td></tr>
                <tr><th><label for="talktopc_landing_card_border_color">Card Border</label></th>
                    <td><input type="text" id="talktopc_landing_card_border_color" name="talktopc_landing_card_border_color" value="<?php echo esc_attr(get_option('talktopc_landing_card_border_color')); ?>" class="ttp-color-picker" data-default-color="#E2E8F0"></td></tr>
                <tr><th><label for="talktopc_landing_card_hover_border_color">Card Hover Border</label></th>
                    <td><input type="text" id="talktopc_landing_card_hover_border_color" name="talktopc_landing_card_hover_border_color" value="<?php echo esc_attr(get_option('talktopc_landing_card_hover_border_color')); ?>" class="ttp-color-picker" data-default-color="#7C3AED"></td></tr>
                <tr><th><label for="talktopc_landing_card_icon_bg_color">Card Icon Background</label></th>
                    <td><input type="text" id="talktopc_landing_card_icon_bg_color" name="talktopc_landing_card_icon_bg_color" value="<?php echo esc_attr(get_option('talktopc_landing_card_icon_bg_color')); ?>" class="ttp-color-picker" data-default-color="#7C3AED"></td></tr>
                <tr><th><label for="talktopc_landing_card_title_color">Card Title Color</label></th>
                    <td><input type="text" id="talktopc_landing_card_title_color" name="talktopc_landing_card_title_color" value="<?php echo esc_attr(get_option('talktopc_landing_card_title_color')); ?>" class="ttp-color-picker" data-default-color="#111827"></td></tr>
        ...
        <div class="ttp-collapsible-content">
            <table class="form-table">
                <tr><th><label for="talktopc_msg_user_bg">User Message Background</label></th>
                    <td><input type="text" id="talktopc_msg_user_bg" name="talktopc_msg_user_bg" value="<?php echo esc_attr(get_option('talktopc_msg_user_bg')); ?>" class="ttp-color-picker" data-default-color="#E5E7EB"></td></tr>
                <tr><th><label for="talktopc_msg_agent_bg">Agent Message Background</label></th>
                    <td><input type="text" id="talktopc_msg_agent_bg" name="talktopc_msg_agent_bg" value="<?php echo esc_attr(get_option('talktopc_msg_agent_bg')); ?>" class="ttp-color-picker" data-default-color="#F3F4F6"></td></tr>
                <tr><th><label for="talktopc_msg_system_bg">System Message Background</label></th>
                    <td><input type="text" id="talktopc_msg_system_bg" name="talktopc_msg_system_bg" value="<?php echo esc_attr(get_option('talktopc_msg_system_bg')); ?>" class="ttp-color-picker" data-default-color="#DCFCE7"></td></tr>
                <tr><th><label for="talktopc_msg_error_bg">Error Message Background</label></th>
                    <td><input type="text" id="talktopc_msg_error_bg" name="talktopc_msg_error_bg" value="<?php echo esc_attr(get_option('talktopc_msg_error_bg')); ?>" class="ttp-color-picker" data-default-color="#FEE2E2"></td></tr>
                <tr><th><label for="talktopc_msg_text_color">Text Color</label></th>
                    <td><input type="text" id="talktopc_msg_text_color" name="talktopc_msg_text_color" value="<?php echo esc_attr(get_option('talktopc_msg_text_color')); ?>" class="ttp-color-picker" data-default-color="#1F2937"></td></tr>
        ...
        <div class="ttp-collapsible-content">
            ...
            <table class="form-table">
                <tr><th><label for="talktopc_voice_mic_color">Mic Button Color</label></th>
                    <td><input type="text" id="talktopc_voice_mic_color" name="talktopc_voice_mic_color" value="<?php echo esc_attr(get_option('talktopc_voice_mic_color')); ?>" class="ttp-color-picker" data-default-color="#7C3AED"></td></tr>
                <tr><th><label for="talktopc_voice_mic_active_color">Mic Active Color</label></th>
                    <td><input type="text" id="talktopc_voice_mic_active_color" name="talktopc_voice_mic_active_color" value="<?php echo esc_attr(get_option('talktopc_voice_mic_active_color')); ?>" class="ttp-color-picker" data-default-color="#EF4444"></td></tr>
            </table>
            ...
            <table class="form-table">
                <tr><th><label for="talktopc_voice_avatar_color">Avatar Background</label></th>
                    <td><input type="text" id="talktopc_voice_avatar_color" name="talktopc_voice_avatar_color" value="<?php echo esc_attr(get_option('talktopc_voice_avatar_color')); ?>" class="ttp-color-picker" data-default-color="#667eea"></td></tr>
                <tr><th><label for="talktopc_voice_avatar_active_color">Avatar Active Background</label></th>
                    <td><input type="text" id="talktopc_voice_avatar_active_color" name="talktopc_voice_avatar_active_color" value="<?php echo esc_attr(get_option('talktopc_voice_avatar_active_color')); ?>" class="ttp-color-picker" data-default-color="#667eea"></td></tr>
            </table>
            ...
            <table class="form-table">
                <tr><th><label for="talktopc_voice_status_title_color">Status Title Color</label></th>
                    <td><input type="text" id="talktopc_voice_status_title_color" name="talktopc_voice_status_title_color" value="<?php echo esc_attr(get_option('talktopc_voice_status_title_color')); ?>" class="ttp-color-picker" data-default-color="#1e293b"></td></tr>
                <tr><th><label for="talktopc_voice_status_subtitle_color">Status Subtitle Color</label></th>
                    <td><input type="text" id="talktopc_voice_status_subtitle_color" name="talktopc_voice_status_subtitle_color" value="<?php echo esc_attr(get_option('talktopc_voice_status_subtitle_color')); ?>" class="ttp-color-picker" data-default-color="#64748b"></td></tr>
            </table>
            ...
            <table class="form-table">
                ...
                <tr><th><label for="talktopc_voice_start_btn_color">Button Color</label></th>
                    <td><input type="text" id="talktopc_voice_start_btn_color" name="talktopc_voice_start_btn_color" value="<?php echo esc_attr(get_option('talktopc_voice_start_btn_color')); ?>" class="ttp-color-picker" data-default-color="#667eea"></td></tr>
                <tr><th><label for="talktopc_voice_start_btn_text_color">Button Text Color</label></th>
                    <td><input type="text" id="talktopc_voice_start_btn_text_color" name="talktopc_voice_start_btn_text_color" value="<?php echo esc_attr(get_option('talktopc_voice_start_btn_text_color')); ?>" class="ttp-color-picker" data-default-color="#FFFFFF"></td></tr>
            </table>
            ...
            <table class="form-table">
                <tr><th><label for="talktopc_voice_transcript_bg_color">Background</label></th>
                    <td><input type="text" id="talktopc_voice_transcript_bg_color" name="talktopc_voice_transcript_bg_color" value="<?php echo esc_attr(get_option('talktopc_voice_transcript_bg_color')); ?>" class="ttp-color-picker" data-default-color="#FFFFFF"></td></tr>
                <tr><th><label for="talktopc_voice_transcript_text_color">Text Color</label></th>
                    <td><input type="text" id="talktopc_voice_transcript_text_color" name="talktopc_voice_transcript_text_color" value="<?php echo esc_attr(get_option('talktopc_voice_transcript_text_color')); ?>" class="ttp-color-picker" data-default-color="#1e293b"></td></tr>
                <tr><th><label for="talktopc_voice_transcript_label_color">Label Color</label></th>
                    <td><input type="text" id="talktopc_voice_transcript_label_color" name="talktopc_voice_transcript_label_color" value="<?php echo esc_attr(get_option('talktopc_voice_transcript_label_color')); ?>" class="ttp-color-picker" data-default-color="#94a3b8"></td></tr>
            </table>
            ...
            <table class="form-table">
                <tr><th><label for="talktopc_voice_control_btn_color">Control Button Color</label></th>
                    <td><input type="text" id="talktopc_voice_control_btn_color" name="talktopc_voice_control_btn_color" value="<?php echo esc_attr(get_option('talktopc_voice_control_btn_color')); ?>" class="ttp-color-picker" data-default-color="#FFFFFF"></td></tr>
                <tr><th><label for="talktopc_voice_control_btn_secondary_color">Secondary Color</label></th>
                    <td><input type="text" id="talktopc_voice_control_btn_secondary_color" name="talktopc_voice_control_btn_secondary_color" value="<?php echo esc_attr(get_option('talktopc_voice_control_btn_secondary_color')); ?>" class="ttp-color-picker" data-default-color="#64748b"></td></tr>
                <tr><th><label for="talktopc_voice_end_btn_color">End Call Button</label></th>
                    <td><input type="text" id="talktopc_voice_end_btn_color" name="talktopc_voice_end_btn_color" value="<?php echo esc_attr(get_option('talktopc_voice_end_btn_color')); ?>" class="ttp-color-picker" data-default-color="#EF4444"></td></tr>
            </table>
        </div>
    </div>
    <?php
        ...
        <div class="ttp-collapsible-content">
            ...
            <table class="form-table">
                <tr><th><label for="talktopc_text_send_btn_color">Button Color</label></th>
                    <td><input type="text" id="talktopc_text_send_btn_color" name="talktopc_text_send_btn_color" value="<?php echo esc_attr(get_option('talktopc_text_send_btn_color')); ?>" class="ttp-color-picker" data-default-color="#7C3AED"></td></tr>
                <tr><th><label for="talktopc_text_send_btn_hover_color">Hover Color</label></th>
                    <td><input type="text" id="talktopc_text_send_btn_hover_color" name="talktopc_text_send_btn_hover_color" value="<?php echo esc_attr(get_option('talktopc_text_send_btn_hover_color')); ?>" class="ttp-color-picker" data-default-color="#6D28D9"></td></tr>
                ...
                <tr><th><label for="talktopc_text_send_btn_text_color">Text Color</label></th>
                    <td><input type="text" id="talktopc_text_send_btn_text_color" name="talktopc_text_send_btn_text_color" value="<?php echo esc_attr(get_option('talktopc_text_send_btn_text_color')); ?>" class="ttp-color-picker" data-default-color="#FFFFFF"></td></tr>
            </table>
            ...
            <table class="form-table">
                ...
                <tr><th><label for="talktopc_text_input_bg_color">Background Color</label></th>
                    <td><input type="text" id="talktopc_text_input_bg_color" name="talktopc_text_input_bg_color" value="<?php echo esc_attr(get_option('talktopc_text_input_bg_color')); ?>" class="ttp-color-picker" data-default-color="#FFFFFF"></td></tr>
                <tr><th><label for="talktopc_text_input_text_color">Text Color</label></th>
                    <td><input type="text" id="talktopc_text_input_text_color" name="talktopc_text_input_text_color" value="<?php echo esc_attr(get_option('talktopc_text_input_text_color')); ?>" class="ttp-color-picker" data-default-color="#1F2937"></td></tr>
                <tr><th><label for="talktopc_text_input_border_color">Border Color</label></th>
                    <td><input type="text" id="talktopc_text_input_border_color" name="talktopc_text_input_border_color" value="<?php echo esc_attr(get_option('talktopc_text_input_border_color')); ?>" class="ttp-color-picker" data-default-color="#E5E7EB"></td></tr>
                <tr><th><label for="talktopc_text_input_focus_color">Focus Color</label></th>
                    <td><input type="text" id="talktopc_text_input_focus_color" name="talktopc_text_input_focus_color" value="<?php echo esc_attr(get_option('talktopc_text_input_focus_color')); ?>" class="ttp-color-picker" data-default-color="#7C3AED"></td></tr>
