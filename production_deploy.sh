...
cd "$PLUGIN_DIR"
rsync -a --exclude='.git' --exclude='*.zip' --exclude='production_deploy.sh' --exclude='production_deploy_readme.sh' --exclude='.gitignore' --exclude='.gitattributes' --exclude='.wordpress-org' --exclude='*.md' . "$PLUGIN_TEMP_DIR/"
